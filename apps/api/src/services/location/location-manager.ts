...
export class LocationManager {
  ...
  private normalizeInvestigation(investigation: VehicleLocation['investigation']): LocationInvestigationTelemetry | null {
    ...
    return {
      ...
      originalLatitude: investigation.originalLatitude ?? null,
      originalLongitude: investigation.originalLongitude ?? null,
      offsetApplied: investigation.offsetApplied ?? null,
      latitudeOffset: investigation.latitudeOffset ?? null,
      longitudeOffset: investigation.longitudeOffset ?? null,
      gnssStaleThresholdMs: investigation.gnssStaleThresholdMs ?? null,
      gnssStale: investigation.gnssStale ?? null,
      communicationFresh: investigation.communicationFresh ?? null,
      positionFresh: investigation.positionFresh ?? null,
      ...
      requestDurationMs: investigation.requestDurationMs ?? null,
      effectiveUpdateIntervalMs: investigation.effectiveUpdateIntervalMs ?? null,
      lastPollStartedAt: investigation.lastPollStartedAt ?? null,
      lastPollCompletedAt: investigation.lastPollCompletedAt ?? null,
